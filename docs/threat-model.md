...
| T17 | Secret from a fork reaches live CI                     | Live job only on explicit `workflow_dispatch`, protected environment secret, manual boolean                        | Authorized maintainer can still opt in incorrectly                             |
